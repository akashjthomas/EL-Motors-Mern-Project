// components/AssistanceRoadTable.js
...
function AssistanceRoadTable() {
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        const response = await axios.get('http://localhost:5000/api/assistance-roads'); // Assuming your backend endpoint is '/api/assistance-roads'
...
export default AssistanceRoadTable;
